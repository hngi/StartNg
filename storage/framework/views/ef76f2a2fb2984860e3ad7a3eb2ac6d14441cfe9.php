                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top"
                                 ...
                                 alt="Card image">
                            <div class="card-body">
                                <h4 class="card-title" style="font-weight: bold;"><?php echo e($item->name); ?></h4>
                                ...
                                <?php if(Auth::guest()): ?>
                                    ...
                                    <?php endif; ?>
                                <?php if(!Auth::guest()): ?>
                                    <a href="<?php echo e(route('register.courses',$item->id)); ?>" class="btn btn-primary pr-3 pl-3 pt-1 pb-1"
                                       style="background-color: #9A75A0; border: thin solid #9A75A0;">Register</a>
                                <?php endif; ?>
                                <a href="<?php echo e(route('details',$item->id)); ?>" class="btn btn-primary pr-3 pl-3 pt-1 pb-1"
...
</html><?php /**PATH C:\New folder\htdocs\StartNg-Development\hngseven\resources\views/frontend/frontend/index.blade.php ENDPATH**/ ?>
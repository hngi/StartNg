    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="table-responsive col-md-10 offset-md-1 mt-5">
                ...
                <?php if($user->role): ?>
                    <div>
                        <a class=" btn btn-info" href="<?php echo e(route('user.disableAdmin',$user->id)); ?>" >Disable Admin Features</a>
                    </div>
                    <?php endif; ?>
                <?php if(!$user->role): ?>
                    <div>
                        <a class=" btn btn-primary" href="<?php echo e(route('user.disableAdmin',$user->id)); ?>" >Enable Admin Features</a>
                    </div>
                <?php endif; ?>
...
</html><?php /**PATH C:\New folder\htdocs\StartNg-Development\hngseven\resources\views/frontend/frontend/user_detail.blade.php ENDPATH**/ ?>
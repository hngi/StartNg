                ...
                <table class="table">
                    ...
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('course.details',$item->id)); ?>"> View</a>
                                <?php if($item->active): ?>
                                <a href="<?php echo e(route('course.disable',$item->id)); ?>"> Disable</a>
                                    <?php endif; ?>
                                <?php if(!$item->active): ?>
                                    <a href="<?php echo e(route('course.disable',$item->id)); ?>"> Enable</a>
                                <?php endif; ?>
                            </td>
...
</html><?php /**PATH C:\New folder\htdocs\StartNg-Development\hngseven\resources\views/frontend/frontend/admin-courses.blade.php ENDPATH**/ ?>
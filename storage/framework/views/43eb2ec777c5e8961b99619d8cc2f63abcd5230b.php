...
<form action="<?php echo e(route('login')); ?>" method="post">
    ...
    <div class="container pt-4 pb-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4"><a href="#" class="forget-password">Forgot Password?</a> | <a href="<?php echo e(route('signup')); ?>">Sign Up</a> </div>
...
</html><?php /**PATH C:\New folder\htdocs\StartNg-Development\hngseven\resources\views/frontend/frontend/login.blade.php ENDPATH**/ ?>
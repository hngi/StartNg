            ...
            <div class="row pt-5">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" <?php if ($errors->has('email')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('email'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>"  name="email" class="form-control" id="email" required>
...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            <div>
                <p>Already have an Account? <a href="<?php echo e(route('signin')); ?>"> Sign IN</a> </p>
            </div>
...
<?php /**PATH C:\New folder\htdocs\StartNg-Development\hngseven\resources\views/frontend/frontend/register.blade.php ENDPATH**/ ?>
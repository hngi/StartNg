        ...
        <div class="container pt-2 pb-2">
            ...
            <div class="navbar-collapse collapse" id="navbar9">
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php if(!Auth::guest()): ?>
                        <li class="nav-item mr-5">
                            <a class="btn btn-success nav-link px-5" href="<?php echo e(route('mycourses',\Illuminate\Support\Facades\Auth::user()->id)); ?>" style="color: #fff;">My courses</a>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item mr-5">
                        <a class="nav-link" href="<?php echo e(route('hire')); ?>">Hire A Grad</a>
                    </li>
                    <li class="nav-item mr-5">
                    ...
                    <?php if(!Auth::guest()): ?>
                        ...
                        <a class="btn btn-success nav-link px-5" href="<?php echo e(route('logout')); ?>"
    ...
    <div class="container-fluid pt-5 pb-5" style="background-color: #F0F2F6;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="font-weight-bold">N<?php echo e($course->price); ?> for <?php echo e($course->duration); ?> months full training </p>
                    <h4 class="font-weight-bold pb-3"><?php echo e($course->name); ?>  Class</h4>
                    <p class="pb-2"><?php echo e($course->description); ?> </p>
                    ...
                    <div class="clearfix">
                        <div class="float-left">
                            ...
                            <?php endif; ?>
                            <?php if(!Auth::guest()): ?>
                                    <a class="btn btn-success pt-1 pb-1" href="<?php echo e(route('register.courses',$item->id)); ?>">Register</a>
                ...
                <div class="col-md-6">
                    <img class="img-fluid" src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1570973825/startng/creative-web-designer-planning-application-developing-template-layout_1418-2436_pca4kd.png">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8 pb-5">
                            ...
                            <form class="form-inline">
                                ...
                                <button type="submit" class="btn btn-primary ml-1 pl-5 pr-5" style="background-color: #44CF6C; border-color: #44CF6C; cursor: pointer;">Subscribe</button>
                            </form>
                        </div>
                        <div class="col-md-4">
...
</html><?php /**PATH C:\New folder\htdocs\StartNg-Development\hngseven\resources\views/frontend/frontend/details-course.blade.php ENDPATH**/ ?>
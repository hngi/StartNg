    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="table-responsive col-md-10 offset-md-1 mt-5">
                <h2 class="text-center mb-5"><?php echo e($course->name); ?></h2>
...
</html><?php /**PATH C:\New folder\htdocs\StartNg-Development\hngseven\resources\views/frontend/frontend/course_detail.blade.php ENDPATH**/ ?>
                        ...
                        <div class="card mb-4 shadow border-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="">
                                        <a href="courses.html" class="btn btn-sm btn-primary rounded-pill py-0 mr-1">Online</a>
                                        <a href="course-curriculum.html" class="btn btn-sm btn-warning rounded-pill py-0">Free</a>
                                    </div>

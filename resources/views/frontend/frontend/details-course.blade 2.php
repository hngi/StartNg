    ...
    <div class="container-fluid pt-5 pb-5" style="background-color: #F0F2F6;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="font-weight-bold">N{{$course->price}} for {{$course->duration}} months full training </p>
                    <h4 class="font-weight-bold pb-3">{{$course->name}}  Class</h4>
                    ...
                    <div class="clearfix">
                        <div class="float-left">
                            ...
                            @endif
                            @if(!Auth::guest())
                                    <a class="btn btn-success pt-1 pb-1" href="{{route('register.courses',$item->id)}}">Register</a>

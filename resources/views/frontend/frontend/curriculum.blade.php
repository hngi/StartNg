...
<body>
    ...
    <div class="container-fluid body-banner pt-5 pb-5">
        <div class="col-md-6 offset-md-1 text-white " id="top">
            ...
            <a class="btn btn-success pl-5 pr-5 mb-4" href="register.blade.php" style="background-color:#44CF6C; color: #fff; border-color: #44CF6C;">Start
                Learning</a>
        </div>
    </div>
    ...
    <div class="container pt-5 pb-5">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <a href="register.blade.php" class="btn btn-success pl-5 pr-5 mb-4" style="background-color:#44CF6C; color: #fff; border-color: #44CF6C;">Start
                    Learning</a>
            </div>
            <div class="col-md-6">

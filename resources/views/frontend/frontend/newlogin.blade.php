...
<div class="container pt-4 pb-5">
    <form action="{{ route('login') }}" method="post">
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="usr" placeholder="Your Email Address" name="email">
                </div>
            </div>
            <div class="col-md-2"></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="pwd" placeholder="Your Password" minlength="8" maxlength="21" minlength="8" name="pwd">
                </div>
            </div>
            <div class="col-md-2"></div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4"><a href="#" class="forget-password">Forgot Password?</a></div>
        </div>

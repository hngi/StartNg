...
<body>
    ...
    <div class="container">
        <div class="clearfix">
            <div class="float-left">
                <p class="pt-5 pb-4"><span style="font-weight: bolder;">100</span> <span>Topics</span> <span
                        class="ml-3" style="font-weight: bolder;">1002
    ...
    <div class="container mb-5 mt-5">
        <div class="row">
            <div class="col-md-3">
                <p><img src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1570900838/startng/fa-solid_check-circle_kinyyl.png"
                        class="img-fluid"> <span>Find answers to your questions</span></p>
            </div>
            <div class="col-md-3">
                <p><img src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1570900838/startng/fa-solid_check-circle_kinyyl.png"
                        class="img-fluid"> <span>Stay up to date on latest topics</span></p>
            </div>
            <div class="col-md-3">
                <p><img src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1570900838/startng/fa-solid_check-circle_kinyyl.png"
                        class="img-fluid"> <span>Ask questions and help others</span></p>
            </div>
            <div class="col-md-3">
                <p class="mt-n2"><a href="help.html" class="btn btn-success">Ask your question</a> <span><a href=""><img
                ...
                <div class="card questions">
                    <div class="card-body">
                        <p><img class="img-fluid"
                                src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1570901441/startng/Group_375_pv8srr.png">
        ...
        <div class="row">
            <div class="col-md-4">
                <ul style="list-style: none; font-weight: 400;">
                    <li class="mt-3"><img class="img-fluid"
                            src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1570902394/startng/octicon-comment-discussion_a68qxr.png">
        ...
        <div class="card col-md-10 mt-2">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <p class="pb-2">StartNG Course registration ends on this date. Lorem ipsum curabitur vitae nunc sed
                        velit dignissim sodales ut eu sem </p>
                </div>
            </div>
    ...
    <div class="container pt-5">
        ...
        <div class="card col-md-10">
            <p class="pt-4"><img
                    src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1570903999/startng/Ellipse_28_zbqscb.png"
                    class="img-fluid ml-2"> <span class="ml-3" style="color: #084482;">Omolara Atoyebi</span>
                <span class="ml-3" style="font-weight: 200;">Student</span>
            </p>
            <p class="ml-5 pl-4" style="font-weight: bold;">Slack status update</p>
            <p class="ml-5 pl-4">I’m finding it hard to update my status on Slack. Who can walk me through this? Lorem
                ipsum curabitur vitae nunc sed velit</p>
    ...
    <div class="container-fluid text-white py-2" style="background: #2E0435; width:100%;">
        <div class="container text-right">
            <div class="row icons">
                <div class="col-md-12 ">
                    <a href="" style="color: #fff;"><i style="color: #fff;" class='fab fa-twitter'

...
<div class="container-fluid body-banner pt-5 pb-5">
        <div class="col-md-6 offset-md-3 text-center" style="color: #fff;">
            ...
            <p class="pb-4" style="font-weight: 600; font-size: 25px;">After 3 months of training and projects, <br> our graduates are ready to take on full-time <br> or remote jobs at your company.</p>
            <a href="hireGrad.html" class="btn btn-success pl-5 pr-5 mb-3" style="background-color: #44CF6C;">Hire a
                Graduate</a>
        </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="col-md-8 offset-md-2">
                    ...
                    <p>Our graduates are versatile, dedicated,Lorem <br> ipsum dolor sit amet, consectetur adipiscing
                        <br> elit, sed do eiusmod tempor incididunt ut <br> labore et dolore magna aliqua. Non diam <br> phasellus vestibulum lorem sed.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row pt-5 pb-5 align-items-center">
            ...
            <div class="col-md-6">
                <div class="col-md-8 offset-md-2">
                    ...
                    <p>Our graduates are taught how to be effective <br> remote employees. Lorem ipsum dolor sit <br> amet, consectetur adipiscing elit, sed do <br> eiusmod tempor incididunt ut labore et dolore
        ...
        <div class="row align-items-center pb-5 pt-5">
            <div class="col-md-6">
                <div class="col-md-8 offset-md-2">
                    ...
                    <p>Let us know what you're looking for. We’ll help <br> you source the ideal candidates for your next <br> full-time hire, without any placement fees.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
    ...
    <div class="container-fluid pt-5 pb-5" style="background-color: #44CF6C;">
        <div class="col-md-10 offset-md-1 pt-5 pb-5">
            ...
            <a class="btn btn-secondary col-md-2 offset-md-5 mt-5" style="background-color: #3A0842; border-color: #3A0842; color: #fff;">Subscribe</a>
        </div>
    </div>
